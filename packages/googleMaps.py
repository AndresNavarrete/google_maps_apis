...
class Directions(GoogleMaps):
   ...
   def getDirections(self, origin, destination, mode, departure_time, parameter_avoid, only_bus):
      directionsResponse = self.getDirectionsResponse(origin, destination, mode, departure_time,  parameter_avoid,  only_bus)
   ...
   def getDirectionsResponse(self, origin, destination, mode, departure_time, parameter_avoid,only_bus = False):
      if only_bus:
